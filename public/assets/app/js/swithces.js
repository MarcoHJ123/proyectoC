...
$(document).ready(function() {
	...
	var dynamic_disable = document.querySelector('.js-dynamic-disable');
	if( dynamic_disable ){
		dynamic_disable.addEventListener('click', function() {
		  switcheryy.disable();
		});
	}

	var dynamic_enable = document.querySelector('.js-dynamic-enable');
	if( dynamic_enable ){
		dynamic_enable.addEventListener('click', function() {
		  switcheryy.enable();
		});
	}
