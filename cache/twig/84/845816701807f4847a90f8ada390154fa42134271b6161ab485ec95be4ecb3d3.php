...
\t\t<a class=\"btn btn-success col-sm-12\" href=\"";
        // line 27
        echo twig_escape_filter($this->env, $this->env->getExtension('Slim\Views\TwigExtension')->baseUrl(), "html", null, true);
        echo "/crear-anuncios/perdido\" id=\"buttone\">APORTAR</a>
\t</div>
...
\t\t<a class=\"btn btn-danger col-sm-12\"  href=\"";
        // line 33
        echo twig_escape_filter($this->env, $this->env->getExtension('Slim\Views\TwigExtension')->baseUrl(), "html", null, true);
        echo "/crear-anuncios/desaparecido\" id=\"buttone\" >APORTAR</a>
\t</div>
...
\t\t<a class=\"btn btn-success col-sm-12\" href=\"{{ base_url() }}/crear-anuncios/perdido\" id=\"buttone\">APORTAR</a>
\t</div>

\t<div class=\"col-sm-6\" id=\"panele\">
\t\t<h4>PERSONAS DESAPARECIDAS</h4>
\t\t<img src=\"{{ base_url() }}/public/assets/images/user-card/img-round5.jpg\" alt=\"bg-img\" class=\"img-responsive\" alt=\"User-Profile-Image\">
\t\t<a class=\"btn btn-danger col-sm-12\"  href=\"{{ base_url() }}/crear-anuncios/desaparecido\" id=\"buttone\" >APORTAR</a>
\t</div>
